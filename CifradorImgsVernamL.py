	...
	if(img!=None):
		...
		while(i<size_img):
			...
			while(j<size_img0):
				...
				k=0
				while(k<3):
					key_00101=generaKeyConLinealC(a,b,x0,n)
		...
		waitKey(0)
		imwrite("cifrada_lin_"+str(Name)+'.bmp',imgcifrada)
...
def descifrar():
	...
	if(img!=None):
		...
		waitKey(0)
		imwrite("descifrada_lin_"+str(Name)+'.bmp',imgdescifrada)
...
def generaKeyConLinealC(a,b,x0,n):
	num=(a*x0+b)%n
	return num
